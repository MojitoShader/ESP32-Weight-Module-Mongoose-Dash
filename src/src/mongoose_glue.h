...
void glue_get_sensor_settings(struct sensor_settings *);
void glue_set_sensor_settings(struct sensor_settings *);
...
void glue_get_sensor_read(struct sensor_read *);
void glue_set_sensor_read(struct sensor_read *);
